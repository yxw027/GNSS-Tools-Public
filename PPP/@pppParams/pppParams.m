classdef pppParams < matlab.mixin.Copyable
    ...
    properties
        ...
        measUse = struct(...
            ...
            'excludeThreshLarge',[30 10 10 Inf],...    % Code, carrier, and doppler and pseudo-meas large residuals thresholds
            'excludeThresh',     [15 0.2 0.25 Inf],... % Code, carrier, and doppler and pseudo-meas residuals thresholds
            'gFreeSlipThresh',   0.05,...          % Threshold for cycle slip- geometry free [m]
            'slipDetector',      'RX_OUTPUT',...   % Cycle slip detector ('RX_OUTPUT','GFREE')
            'noVertVel',         true);            % 0 vertical velocity constraint
        ...
        SIGMA0 = struct(...
            ...
            'L1_IONO',  10,...             % Slant L1 iono delay 
        ...
        Q = struct(...
            ...
            'RXB',             1,...               % Receiver clock bias
            'DRXB',            0.25,...              % Receiver clock drift
