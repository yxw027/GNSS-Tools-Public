function [obs_struct,obs_mat] = RINEX_get_obs_fullObs(file_RINEX, nSat, sat, sat_types, ...
...
%     'L5', zeros(nSatTot,1), 'C5', zeros(nSatTot,1), ...
%     'S5', zeros(nSatTot,1));
% % for idx = 1:length(obsTypes)
% %    obs_struct.(obsTypes{idx}) = zeros(nSatTot,1);
% % end
...
%                     obsTypei = obsTypes{obs_col_mat(consti,:) == k};
